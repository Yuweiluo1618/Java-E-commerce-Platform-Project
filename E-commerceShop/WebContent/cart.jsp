...
<div class="cart mt"><!-----------------logo------------------->
    ...
    <!-----------------site------------------->
    <div class="site">
    <p class=" wrapper clearfix"><span class="fl">Cart</span><img class="top" src="">
    <a href="indexselect" class="fr">Continue Shopping&gt;</a>
    </p>
    </div>
    <!-----------------table------------------->
    <div class="table wrapper">
        ...
        <div class="th">
            ...
            <a class="fl" href="selectproductview?id=${rs.cart_p_id }">
                <dl class="clearfix">
                    <dt class="fl"><img src="images/product/${rs.cart_p_filename }" width="120px" height ="120px" ></dt>
         ...
         <div class="price">$${rs.cart_p_price }</div>
            <div class="number">
            <p class="num clearfix"><img class="fl sub" src="img/temp/sub.jpg">
            <span class="fl">${rs.cart_quantity }</span>
            <img class="fl add" src="img/temp/add.jpg">
            </p>
            </div>
            <div class="price sAll">$${rs.cart_p_price*rs.cart_quantity }</div>
            <div class="price"><a class="del" href="#2">Delete</a></div>
        </div>
        </c:forEach>
        <div class="goOn">Empty Cart~<a href="indexselect">去逛逛</a></div>
        <div class="tr clearfix"><label class="fl"><input class="checkAll" type="checkbox"/><span></span></label>
            ...
            <p class="fr"><span>Total <small id="sl">0</small> Product</span><span>Total:&nbsp;<small id="all">$0.00</small></span><a
                    href="order.html" class="count">Pay Now</a></p></div>
    </div>
</div>
<div class="mask"></div>
