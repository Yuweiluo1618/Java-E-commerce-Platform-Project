...
<div class="admin_login_wrap">
    ...
    <div class="adming_login_border">
        <div class="admin_input">
            <form action="/E-commerceShop/manage/adminlogin" method="post">
    ...
    <p class="admin_copyright"><a tabindex="5" href="#" target="_blank">main</a> &copy;<a href="http://www.lmonkey.com/" target="_blank"></a></p>
</div>
</body>
</html>