...
<%@ include file="admin_menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.jsp">Main</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="">Category</a><span class="crumb-step">&gt;</span><span>Modify</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/E-commerceShop/manage/admin_docateupdate" method="post" id="myform" name="myform">
