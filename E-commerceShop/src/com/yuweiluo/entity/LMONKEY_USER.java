package com.yuweiluo.entity;

public class LMONKEY_USER {
	 private String USER_ID;
	 private String USER_NAME;
	 private String USER_PASSWOR;
	 ...
	 public LMONKEY_USER(String uSER_ID, String uSER_NAME, String uSER_PASSWOR, String uSER_SEX, String uSER_BIRTHDAY,
			String uSER_IDENITY_CODE, String uSER_EMAIL, String uSER_MOBILE, String uSER_ADDRESS, int uSER_STATUS) {
		super();
		USER_ID = uSER_ID;
		USER_NAME = uSER_NAME;
		USER_PASSWOR = uSER_PASSWOR;
		USER_SEX = uSER_SEX;
	...
	public String getUSER_PASSWOR() {
		return USER_PASSWOR;
	}

	public void setUSER_PASSWOR(String uSER_PASSWOR) {
		USER_PASSWOR = uSER_PASSWOR;
	}
